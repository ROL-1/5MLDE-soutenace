...
from scripts.prefect.data_wrangling import clean_data_flow
from scripts.prefect.exploratory_data_analysis import data_visualization_flow
from scripts.prefect.model_predictions import wine_quality_prediction_flow

import os

@flow(name='Final Workflow')
